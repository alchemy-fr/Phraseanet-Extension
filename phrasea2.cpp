...
PHP_MINIT_FUNCTION(phrasea2)
{
	...
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_OP_OR", PHRASEA_OP_OR, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_OP_AND", PHRASEA_OP_AND, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_KW_ALL", PHRASEA_KW_ALL, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_KW_LAST", PHRASEA_KW_LAST, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_KW_FIRST", PHRASEA_KW_FIRST, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_OP_EXCEPT", PHRASEA_OP_EXCEPT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_OP_NEAR", PHRASEA_OP_NEAR, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_OP_BEFORE", PHRASEA_OP_BEFORE, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_OP_AFTER", PHRASEA_OP_AFTER, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_OP_IN", PHRASEA_OP_IN, CONST_CS | CONST_PERSISTENT);

	REGISTER_LONG_CONSTANT((char *)"PHRASEA_OP_COLON", PHRASEA_OP_COLON, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_OP_EQUAL", PHRASEA_OP_EQUAL, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_OP_NOTEQU", PHRASEA_OP_NOTEQU, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_OP_GT", PHRASEA_OP_GT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_OP_LT", PHRASEA_OP_LT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_OP_GEQT", PHRASEA_OP_GEQT, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_OP_LEQT", PHRASEA_OP_LEQT, CONST_CS | CONST_PERSISTENT);

	REGISTER_LONG_CONSTANT((char *)"PHRASEA_KEYLIST", PHRASEA_KEYLIST, CONST_CS | CONST_PERSISTENT);

	REGISTER_LONG_CONSTANT((char *)"PHRASEA_MULTIDOC_DOCONLY", PHRASEA_MULTIDOC_DOCONLY, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_MULTIDOC_REGONLY", PHRASEA_MULTIDOC_REGONLY, CONST_CS | CONST_PERSISTENT);

	REGISTER_LONG_CONSTANT((char *)"PHRASEA_ORDER_DESC", PHRASEA_ORDER_DESC, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_ORDER_ASC", PHRASEA_ORDER_ASC, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT((char *)"PHRASEA_ORDER_ASK", PHRASEA_ORDER_ASK, CONST_CS | CONST_PERSISTENT);
